...
func (x *SubEvent) GetAddress() []byte {
	if x != nil {
		return x.Address
	}
	return nil
...
func (x *SubEvent) GetLabels() []*Label {
	if x != nil {
		return x.Labels
	}
	return nil
...
var file_subscribe_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x05, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x22, 0x5c, 0x0a, 0x08, 0x53, 0x75, 0x62, 0x45,
	...
	0x12, 0x24, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x0c, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x06,
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x22, 0x37, 0x0a, 0x05, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x12,
	...
	0x11, 0x5a, 0x0f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
...
var file_subscribe_proto_goTypes = []interface{}{
	(*SubEvent)(nil), // 0: model.SubEvent
	(*Label)(nil),    // 1: model.Label
}
var file_subscribe_proto_depIdxs = []int32{
	1, // 0: model.SubEvent.labels:type_name -> model.Label
