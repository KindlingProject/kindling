...
func TestTextEvent(t *testing.T) {
	...
	assert.Equal(t,
		`{Name:read Category:3 ParamsNumber:3 UserAttributes:[starttime:UINT(1666085694803271345) data:BYTEBUF(POST /test?sleep=800 HTTP/1.1 Host: 10.10.103.148:9000 Content-Type: applica)] Ctx:{ThreadInfo:{Pid:22592 Tid:22592 Uid:0 Gid:0 Comm:node ContainerId:123123 ContainerName:test} FdInfo:{Num:19 TypeFd:3 Filename:tmp Directory:/root Protocol:1 Role:true Sip:127.0.0.1 Dip:127.0.0.1 Sport:39620 Dport:37093 Source:0 Destination:0}} Latency:100 Timestamp:160000}`,
