...
function getAllNodes(list, data, parentId) {
...
function TraceTopology({data}: any) {
    ...
    const draw = (nodeList, chartWarp, level) => {
        let nodeLevelG;
        ...
        nodeList.forEach(node => {
            ...
            const rect = nodeLevelG.append('rect')
                ...
                .attr('height', 20)
                .attr('fill', () => {
                    // if (node.isMutated && node.isProfiled) {
                    //     return '#ff3c3c';
                    // } else {
            ...
            nodeLevelG.append('text')
                ...
                .attr('style', 'font-size: 12px; fill: #595959; pointer-events: none;')
                .attr('x', left + 5)
                .attr('y', 20);
            ...
            rect.on('click', function(this: any, e: any) {
                ...
                let node = nodes.current.find(opt => opt.key === key);
