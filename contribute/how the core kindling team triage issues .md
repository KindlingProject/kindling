...
The easiest and straight forward way of getting started and finding issues that haven't been triaged is to browse [unlabeled issues](%E9%93%BE%E6%8E%A5%E8%87%AA%E5%B7%B1) and starting from the bottom and working yourself to the top.
...
Before triaging an issue very far, make sure that the issue's author provided the standard issue information. This will help you make an educated recommendation on how to categorize the issue. The kindling project utilizes [GitHub issue templates](%E8%87%AA%E5%B7%B1%E9%93%BE%E6%8E%A5) to guide contributors to provide standard information that must be included for each type of template or type of issue.
...
When you feel you have all the information needed you're ready to [categorizing the issue](#categorizing-an-issue).
...
4. Move on to prioritizing the issue(https://github.com/kindling/kindling/blob/main/ISSUE_TRIAGE.md#4-prioritization-of-issues).

**It can't be reproduced:**

1. Either [ask for more information](https://github.com/kindling/kindling/blob/main/ISSUE_TRIAGE.md#2-ensure-the-issue-contains-basic-information) needed to investigate it more thoroughly.
2. Either [delegate further investigations](https://github.com/kindling/kindling/blob/main/ISSUE_TRIAGE.md#investigation-of-issues) to someone else.
...
2. Move on to [prioritizing the issue](https://github.com/kindling/kindling/blob/main/ISSUE_TRIAGE.md#4-prioritization-of-issues).
...
1. Kindly and politely direct the issue author to the [github discussion](自己的gi thub discussion) and explain that GitHub is mainly used for tracking bugs and feature requests. If possible, it's usually a good idea to add some pointers to the issue author's question.
...
4. Consider requesting [help from the community](%E8%87%AA%E5%B7%B1%E7%9A%84%E8%BF%9E%E6%8E%A5), even though it may be problematic given a short amount of time until it should be released.

**Important long-term**

1. Label the issue `priority/important-longterm`.
2. Consider requesting [help from the community](%E8%87%AA%E5%B7%B1%E7%9A%84%E8%BF%9E%E6%8E%A5).
...
When an issue has all basic information provided, but the triage responsible haven't been able to reproduce the reported problem at a first glance, the issue is labeled [Needs investigation](issues见面 链接到). Depending on the perceived severity and/or number of [upvotes](https://help.github.com/en/articles/about-conversations-on-github#reacting-to-ideas-in-comments), the investigation will either be delegated to another maintainer for further investigation or put on hold until someone else (maintainer or contributor) picks it up and eventually starts investigating it.
...
## Automation(搭建git-bot,连接后续改)

We have some automation that triggers on comments or labels being added to issues. Many of these automated behaviors are defined in [commands.json](https://github.com/kindling/kindling/blob/main/.github/commands.json). Or in other [GitHub Actions](https://github.com/kindling/kindling/tree/main/.github/workflows)

- Add /duplicate `#<issue number>` to have Kindling label & close issue with an appropriate message.
- Add `bot/question` and the bot will close it with an appropriate message.

[Read more on bot actions](https://github.com/kindling/kindling/blob/main/.github/bot.md)
