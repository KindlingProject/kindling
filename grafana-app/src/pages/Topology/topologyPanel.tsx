...
import { MetricType, TopologyOptions } from './types';
import './index.scss';
import * as G6 from '@antv/g6';
import _ from 'lodash';
import './services/node';
import './services/edge';
import { nodeTooltip } from './services/tooltip';
import TopoLegend from './services/legend';
import { metricList, metricDataName, layoutOptions, directionOptions, viewRadioOptions, showServiceOptions, NodeDataProps, EdgeDataProps, 
  ...
  updateEdge } from './services/services'; 
import { buildLayout, serviceLineUpdate, updateLinesAndNodes } from './services/topology'
import { css } from '@emotion/css';
import { useStyles2, Select, RadioButtonGroup, Icon, Tooltip, Spinner } from '@grafana/ui';
import { metricQuery } from './topologyDataSource'; 
...
function TopologyPanel(props: Props) {
    const { width, height, options, data, timeRange, replaceVariables } = props;
