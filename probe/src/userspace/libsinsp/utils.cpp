...
#include <WinSock2.h>
#include "src/userspace/libsinsp/Shlwapi.h"
...
#include "src/userspace/libsinsp/sinsp_signal.h"
...
#include "src/userspace/libsinsp/uri.h"
#ifndef _WIN32
#include "curl/curl.h"
#endif
...
void sinsp_utils::ts_to_iso_8601(uint64_t ts, OUT string* res)
{
	...
	static const uint32_t fmtlen = strlen(fmt);
	char buf[fmtlen];
