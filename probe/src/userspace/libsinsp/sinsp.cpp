...
#include "src/userspace/libsinsp/scap_open_exception.h"
#include "src/userspace/libsinsp/sinsp.h"
#include "src/userspace/libsinsp/sinsp_int.h"
#include "src/userspace/libsinsp/filter.h"
#include "src/userspace/libsinsp/filterchecks.h"
#include "src/userspace/libsinsp/protodecoder.h"
...
#ifdef HAS_ANALYZER
#include "src/userspace/libsinsp/analyzer_int.h"
#include "src/userspace/libsinsp/analyzer.h"
#include "src/userspace/libsinsp/tracer_emitter.h"
#endif

void on_new_entry_from_proc(void* context, scap_t* handle, int64_t tid, scap_threadinfo* tinfo,
							scap_fdinfo* fdinfo);

static const char *HCMINE_SKB_CAPTURE_ENV = "HCMINE_SKB_CAPTURE";
///////////////////////////////////////////////////////////////////////////////
...
void sinsp::init()
{
	...
	const char *skb_capture = getenv(HCMINE_SKB_CAPTURE_ENV);
...
void sinsp::fill_eventmask()
{
	if (scap_fill_eventmask(m_h) != SCAP_SUCCESS)
	{
		throw sinsp_exception(scap_getlasterr(m_h));
	}
}
