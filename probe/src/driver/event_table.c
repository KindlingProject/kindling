...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_NETIF_RECEIVE_SKB_E */{"ingress", EC_NET, EF_DROP_SIMPLE_CONS | EF_NONE_PARSE, 5, {{"dev", PT_BYTEBUF, PF_NA}, {"skb_addr", PT_UINT64, PF_HEX}, {"src_mac", PT_BYTEBUF, PF_NA}, {"dst_mac", PT_BYTEBUF, PF_NA}, {"tuple", PT_SOCKTUPLE, PF_NA} } },
	/* PPME_NETIF_RECEIVE_SKB_X */{"ingress", EC_NET, EF_UNUSED, 0},
	/* PPME_NET_DEV_XMIT_E */{"egress", EC_NET, EF_DROP_SIMPLE_CONS | EF_NONE_PARSE, 5, {{"dev", PT_BYTEBUF, PF_NA}, {"skb_addr", PT_UINT64, PF_HEX}, {"src_mac", PT_BYTEBUF, PF_NA}, {"dst_mac", PT_BYTEBUF, PF_NA}, {"tuple", PT_SOCKTUPLE, PF_NA} } },
	/* PPME_NET_DEV_XMIT_X */{"egress", EC_NET, EF_UNUSED, 0},
