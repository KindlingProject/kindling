...
enum ppm_event_type {
	...
	PPME_NETIF_RECEIVE_SKB_E = 318,
	PPME_NETIF_RECEIVE_SKB_X = 319,
	PPME_NET_DEV_XMIT_E = 320,
	PPME_NET_DEV_XMIT_X = 321,
	PPME_TCP_RCV_ESTABLISHED_E = 322,
	PPME_TCP_RCV_ESTABLISHED_x = 323,
	PPME_TCP_CLOSE_E = 324,
	PPME_TCP_CLOSE_X = 325,
    PPME_TCP_DROP_E = 326,
    PPME_TCP_DROP_X = 327,
    PPME_TCP_RETRANCESMIT_SKB_E = 328,
    PPME_TCP_RETRANCESMIT_SKB_X = 329,
	PPM_EVENT_MAX = 330
};
/*@}*/
...
#define PPM_IOCTL_MASK_FILL_EVENTS _IO(PPM_IOCTL_MAGIC, 50)
